...
import java.io.{FileWriter, PrintWriter}
  ...
  object fileOper {
    ...
    def seperateAsChr(filenm:String = gPms.op+"lggsnpti.txt",map:Map[String,Array[String]],outFile:String = gPms.op+"Tcga_lgg_snpChrn.txt",col:Int = 0,filter:Float = 1.0f):Unit={
      ...
      val writeChr2 = new PrintWriter(new FileWriter(outFile+"SNPCHR2.txt"))
      val writeChr3 = new PrintWriter(new FileWriter(outFile+"SNPCHR3.txt"))
      val writeChr4 = new PrintWriter(new FileWriter(outFile+"SNPCHR4.txt"))
      val writeChr5 = new PrintWriter(new FileWriter(outFile+"SNPCHR5.txt"))
      val writeChr6 = new PrintWriter(new FileWriter(outFile+"SNPCHR6.txt"))
      val writeChr7 = new PrintWriter(new FileWriter(outFile+"SNPCHR7.txt"))
      val writeChr8 = new PrintWriter(new FileWriter(outFile+"SNPCHR8.txt"))
      val writeChr9 = new PrintWriter(new FileWriter(outFile+"SNPCHR9.txt"))
      val writeChr10 = new PrintWriter(new FileWriter(outFile+"SNPCHR10.txt"))
      val writeChr11 = new PrintWriter(new FileWriter(outFile+"SNPCHR11.txt"))
      val writeChr12 = new PrintWriter(new FileWriter(outFile+"SNPCHR12.txt"))
      val writeChr13 = new PrintWriter(new FileWriter(outFile+"SNPCHR13.txt"))
      val writeChr14 = new PrintWriter(new FileWriter(outFile+"SNPCHR14.txt"))
      val writeChr15 = new PrintWriter(new FileWriter(outFile+"SNPCHR15.txt"))
      val writeChr16 = new PrintWriter(new FileWriter(outFile+"SNPCHR16.txt"))
      val writeChr17 = new PrintWriter(new FileWriter(outFile+"SNPCHR17.txt"))
      val writeChr18 = new PrintWriter(new FileWriter(outFile+"SNPCHR18.txt"))
      val writeChr19 = new PrintWriter(new FileWriter(outFile+"SNPCHR19.txt"))
      val writeChr20 = new PrintWriter(new FileWriter(outFile+"SNPCHR20.txt"))
      val writeChr21 = new PrintWriter(new FileWriter(outFile+"SNPCHR21.txt"))
      val writeChr22 = new PrintWriter(new FileWriter(outFile+"SNPCHR22.txt"))
      val writeChrX = new PrintWriter(new FileWriter(outFile+"SNPCHRX.txt"))
      val writeChrY = new PrintWriter(new FileWriter(outFile+"SNPCHRY.txt"))
      val writeChrMT = new PrintWriter(new FileWriter(outFile+"SNPCHRMT.txt"))
